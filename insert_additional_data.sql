-- Additional data from PDF document
-- Data fasilitas IPALD di Kota Baubau dan sekitarnya

USE si_pal;

-- Clear existing data first (optional)
-- DELETE FROM pengelolaan_air_limbah WHERE id > 3;

-- Insert additional IPALD facilities from PDF data
